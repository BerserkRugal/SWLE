...
This repository contains supplementary artifacts of SWLE, a novel reputation-based leader election mechanism for partially synchronous Byzantine Fault Tolerant (BFT) protocols.
